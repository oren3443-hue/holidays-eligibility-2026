...
const Exporter = (function () {
  ...
  const COLUMNS_INDEPENDENCE = [
    ...
    { key: "startDate", header: "תאריך תחילת עבודה", type: "date", width: 16 },
    { key: "tenureOk", header: "ותק תקין?", fmt: "yesno", width: 10 },
    { key: "presenceType_21_4", header: "סוג נוכחות 21.4", type: "string", width: 14 },
    { key: "presence_21_4", header: "פירוט 21.4", type: "string", width: 22 },
    { key: "hours_21_4", header: "שעות 21.4", type: "number", numFmt: "0.00", width: 11 },
    { key: "presenceType_22_4", header: "סוג נוכחות 22.4", type: "string", width: 14 },
    { key: "presence_22_4", header: "פירוט 22.4", type: "string", width: 22 },
    { key: "hours_22_4", header: "שעות 22.4", type: "number", numFmt: "0.00", width: 11 },
    { key: "presenceType_23_4", header: "סוג נוכחות 23.4", type: "string", width: 14 },
    { key: "presence_23_4", header: "פירוט 23.4", type: "string", width: 22 },
